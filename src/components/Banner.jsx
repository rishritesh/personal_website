    ...
    >
      ...
      <div className="w-full flex items-center justify-center text-white ">
        ...
        <div className="w-2/3 space-y-2  ms-10">
          ...
          <p className="">
            To get Opportunity that allows to me showcase my skills and contribute to company growth. To enhance
            my skills by taking on this challenging position and expanding my knowledge.
            <p>Languages: Java, JavaScript</p>
            <p>Frameworks: SpringBoot Framework, Hibernate, React JS</p>
            <p>Tools: Eclipse, IntelliJ IDEA, Git, Maven, Jenkins</p>
            <p>Databases: MySQL, PostgreSQL, Oracle</p>
           <p> Other: RESTful APIs, JSON, JPA, AWS , Jenkis, Postman </p>
          </p>
          ...
          <Link
            ...
            href="/personal_website_yt/contact"
          >
            Contact Me
          </Link>
        </div>
